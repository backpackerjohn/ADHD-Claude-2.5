...
**W3 — Retire and rekindle:** From a Briefing, "Retire with honor" → Closing Note appears for edit → Thread to gallery. Months later, gallery card → Restore → rekindled to Warm row, Digest refreshed, Warm Start queued ("You retired this in March. Here's what you had…").
